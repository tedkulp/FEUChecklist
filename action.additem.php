...
$field_names = array('subject', 'reference', 'due_date', 'filedesc', 'links');
...
$links = get_parameter_value($params, 'links', '');
...
$smarty->assign('inputlinks', $this->CreateTextArea(true, $id, $links, 'links'));
